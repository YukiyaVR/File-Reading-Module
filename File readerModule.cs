...
{
    public class FileReaderModule : ChatBoxModule
    {
        public override string Title => "File Reader";
        public override string Description => "Reads the contents of a text file";
        public override string Author => "YukiyaVR";
        public override ModuleType Type => ModuleType.General;

        protected override TimeSpan DeltaUpdate => TimeSpan.FromSeconds(1.5);
